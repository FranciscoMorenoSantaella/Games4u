    ...
    public ResponseEntity<?> payment(@RequestBody Pay pay) throws Exception {
        try {
            Payment payment = service.createPayment(pay.getPrice(), pay.getCurrency(), pay.getMethod(),
                    pay.getIntent(), pay.getDescription(), pay.getUser_id(), "https://games4u.onrender.com/game" + CANCEL_URL,
                    "https://games4u.onrender.com/" + SUCCESS_URL + "?user_id=" + pay.getUser_id());
